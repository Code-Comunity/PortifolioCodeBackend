...
var AuthController = /** @class */ (function () {
    ...
    //criando usuario
    AuthController.prototype.CreateUser = function (Req, Res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        return [2 /*return*/, Res.status(200).send({ message: "Usuario criado" })];
                    case 3:
                        error_1 = _b.sent();
    ...
    AuthController.prototype.Authenticate = function (Req, Res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, password, UserExists, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = Req.body, username = _a.username, password = _a.password;
                    ...
                    case 2:
                        ...
                        // Tratando erros possíveis.
                        if (!UserExists)
                            return [2 /*return*/, Res.status(401).send({ message: "Desculpe " + username + ", aqui consta q seu usuario n\u00E3o existe!" })];
                        if (password === UserExists.password)
                            return [2 /*return*/, Res.status(401).send({ message: "Desculpe " + username + ", aqui consta q seu usuario n\u00E3o existe!" })
                                // Falta implementar token
                            ];
                        // Falta implementar token
                        return [2 /*return*/, Res.status(200).send({ message: username + " logado!" })];
                    case 3:
                        error_3 = _b.sent();
                        return [2 /*return*/, Res.status(401).send({ message: "Desculpe " + username + " n\u00E3o foi possivel logar!" })];
                    case 4: return [2 /*return*/];
                }
            });
        });
